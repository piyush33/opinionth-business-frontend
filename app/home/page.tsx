...
import { Bell, MessageCircle, User, ChevronDown, Search, X, Menu, Home, Compass, Plus } from "lucide-react"
...
export default function HomePage() {
    ...
    const filteredHomeFeed = homeFeed.filter((item: any) => {
                ...
                <div className="px-4 py-3 space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                        <Link href="/home" className="flex items-center space-x-2">
                            ...
                            <span className="font-bold text-lg text-gray-900">Opinio^nth</span>
                        </Link>
