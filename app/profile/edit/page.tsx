...
export default function EditProfilePage() {
    ...
    const handleImageUpload = async (file: File) => {
        ...
        try {
            const response = await axios.post(`https://d3kv9nj5wp3sq6.cloudfront.net/uploads/profile`, formDataUpload, {
                headers: {
    ...
    const handleSave = async () => {
        ...
        setIsLoading(true)
        try {
            const response = await axios.put(`https://d3kv9nj5wp3sq6.cloudfront.net/profileusers/${user.username}`, formData)
                            ...
                            {activeSection === "profile" && (
                                <>
                                    <div className="mb-6 lg:mb-8">
                                        <h2 className="text-xl lg:text-2xl font-bold text-gray-900 mb-2">Edit Profile</h2>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500 mt-1 break-all">www.yoursite.com/@{formData.username}</p>
                                        </div>
                                    ...
                                    <div className="mt-6 lg:mt-8 pt-6 lg:pt-8 border-t border-gray-200">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                                                ...
                                                <button
                                                    onClick={() =>
                                                        setPrivacySettings((prev) => ({ ...prev, allowMessages: !prev.allowMessages }))
                                                    }
                                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${privacySettings.allowMessages ? "bg-purple-600" : "bg-gray-200"
                                                        }`}
                                                >
                                                    <span
                                                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${privacySettings.allowMessages ? "translate-x-6" : "translate-x-1"
                                                            }`}
                                                    />
                                                </button>
                                            </div>
                                            ...
                                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                                                <div>
                                                    <label className="text-sm font-medium text-gray-700">Allow Follows</label>
                                                    <p className="text-xs text-gray-500">Let others follow you</p>
                                                </div>
                                                <button
                                                    onClick={() => setPrivacySettings((prev) => ({ ...prev, allowFollows: !prev.allowFollows }))}
                                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${privacySettings.allowFollows ? "bg-purple-600" : "bg-gray-200"
                                                        }`}
                                                >
                                                    <span
                                                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${privacySettings.allowFollows ? "translate-x-6" : "translate-x-1"
                                                            }`}
                                                    />
                                                </button>
                                            </div>
